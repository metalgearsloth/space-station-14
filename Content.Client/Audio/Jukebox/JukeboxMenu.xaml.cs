...
public sealed partial class JukeboxMenu : FancyWindow
{
    ...
    private JukeboxPlaybackState _playbackState;
    ...
    public void SetPlaybackState(JukeboxPlaybackState state)
    {
        _playbackState = state;
        SetPlayPauseButton(state == JukeboxPlaybackState.Playing);
    }
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        if (_playbackState == JukeboxPlaybackState.Stopped)
        {
            DurationLabel.Text = $@"{TimeSpan.Zero:mm\:ss} / {TimeSpan.FromSeconds(PlaybackSlider.MaxValue):mm\:ss}";
        }
        else if (_entManager.TryGetComponent(_audio, out audio))
        {
        ...
        else if (audio != null || _entManager.TryGetComponent(_audio, out audio))
        {
