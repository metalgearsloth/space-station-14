...
public sealed partial class DungeonJob
{
    ...
    /// </summary>
    private async Task<List<Dungeon>> GenerateExteriorDungeon(Vector2i position, ProceduralData data, ExteriorDunGen dungen, HashSet<Vector2i> reservedTiles, int seed)
    {
