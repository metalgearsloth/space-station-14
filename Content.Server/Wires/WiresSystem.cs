...
public sealed class WiresSystem : SharedWiresSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<WiresComponent, DoorBoltsChangedEvent>(OnBoltChanged);
    ...
    private void OnBoltChanged(Entity<WiresComponent> ent, ref DoorBoltsChangedEvent args)
    {
