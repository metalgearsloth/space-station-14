...
namespace Content.Server.Atmos.Piping.Binary.EntitySystems
{
    ...
    public sealed class GasReyclerSystem : EntitySystem
    {
        ...
        private void OnExamined(Entity<GasRecyclerComponent> ent, ref ExaminedEvent args)
        {
            ...
            if (!_nodeContainer.TryGetNode(ent.Owner, comp.InletName, out Shared.NodeContainer.Nodes.PipeNode? inlet))
                return;
        ...
        {
            var comp = ent.Comp;
            if (!_nodeContainer.TryGetNodes(ent.Owner, comp.InletName, comp.OutletName, out Shared.NodeContainer.Nodes.PipeNode? inlet, out Shared.NodeContainer.Nodes.PipeNode? outlet))
            {
