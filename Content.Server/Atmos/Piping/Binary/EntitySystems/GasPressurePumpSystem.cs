...
public sealed class GasPressurePumpSystem : SharedGasPressurePumpSystem
{
    ...
    private void OnPumpUpdated(Entity<GasPressurePumpComponent> ent, ref AtmosDeviceUpdateEvent args)
    {
        if (!ent.Comp.Enabled
            ...
            || !_nodeContainer.TryGetNodes(ent.Owner, ent.Comp.InletName, ent.Comp.OutletName, out Shared.NodeContainer.Nodes.PipeNode? inlet, out Shared.NodeContainer.Nodes.PipeNode? outlet))
        {
