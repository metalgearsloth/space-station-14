...
namespace Content.Server.Atmos.Piping.Trinary.EntitySystems
{
    ...
    public sealed class GasFilterSystem : EntitySystem
    {
        ...
        {
            if (!filter.Enabled
                || !_nodeContainer.TryGetNodes(uid, filter.InletName, filter.FilterName, filter.OutletName, out Shared.NodeContainer.Nodes.PipeNode? inletNode, out Shared.NodeContainer.Nodes.PipeNode? filterNode, out Shared.NodeContainer.Nodes.PipeNode? outletNode)
        ...
        private void OnFilterAnalyzed(EntityUid uid, GasFilterComponent component, GasAnalyzerScanEvent args)
        {
            ...
            if (_nodeContainer.TryGetNode(uid, component.InletName, out Shared.NodeContainer.Nodes.PipeNode? inlet) && inlet.Air.Volume != 0f)
            {
            ...
            if (_nodeContainer.TryGetNode(uid, component.FilterName, out Shared.NodeContainer.Nodes.PipeNode? filterNode) && filterNode.Air.Volume != 0f)
            {
