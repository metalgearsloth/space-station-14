...
namespace Content.Server.GameObjects.Components.Fluids
{
    public static class SpillExtensions
    {
        ...
        public static bool TryGetPuddle(this TileRef tileRef, SharedEntityLookupSystem? sharedEntityLookupSystem, [NotNullWhen(true)] out PuddleComponent? puddle)
        {
            foreach (var entity in tileRef.GetEntitiesInTileFast(sharedEntityLookupSystem))
            {
